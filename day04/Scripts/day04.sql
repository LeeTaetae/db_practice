...
SELECT * FROM TBL_REPLY;
SELECT * FROM TBL_POST WHERE ID IN (SELECT AVG(ID) FROM TBL_REPLY GROUP BY ID HAVING COUNT(ID) < AVG(ID));
SELECT * FROM TBL_USER WHERE ID IN (SELECT USER_ID FROM TBL_POST WHERE USER_ID IN (SELECT AVG(ID) FROM TBL_REPLY GROUP BY ID HAVING COUNT(ID) < AVG(ID)));
